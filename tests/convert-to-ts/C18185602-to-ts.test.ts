...
it("should convert C18185602 into typescript file", async () => {
  ...
  expect(result).toMatchInlineSnapshot(`
    ...
    <platedhole  portHints={["pin1"]} pcbX="3.749929mm" pcbY="2.29997mm" holeWidth="0.5999988mm" holeHeight="1.499997mm" outerWidth="1.1999976mm" outerHeight="2.0999958mm" shape="pill" />
    <platedhole  portHints={["pin2"]} pcbX="-0.250063mm" pcbY="2.29997mm" holeWidth="0.5999988mm" holeHeight="1.499997mm" outerWidth="1.1999976mm" outerHeight="2.0999958mm" shape="pill" />
    <platedhole  portHints={["pin3"]} pcbX="-3.250057mm" pcbY="2.29997mm" holeWidth="0.5999988mm" holeHeight="1.499997mm" outerWidth="1.1999976mm" outerHeight="2.0999958mm" shape="pill" />
    <platedhole  portHints={["pin4"]} pcbX="4.850003mm" pcbY="-2.29997mm" holeWidth="0.5999988mm" holeHeight="1.499997mm" outerWidth="1.1999976mm" outerHeight="2.0999958mm" shape="pill" />

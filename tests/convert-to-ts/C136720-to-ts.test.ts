...
it("should convert C136720 slide switch into a switch component with pin labels", async () => {
  ...
  expect(result).toMatchInlineSnapshot(`
    ...
    <courtyardoutline outline={[{"x":-2.6829898000000156,"y":7.826997800000001},{"x":8.016989800000005,"y":7.826997800000001},{"x":8.016989800000005,"y":-7.826997800000001},{"x":-2.6829898000000156,"y":-7.826997800000001},{"x":-2.6829898000000156,"y":7.826997800000001}]} />
          </footprint>}
          cadModel={{

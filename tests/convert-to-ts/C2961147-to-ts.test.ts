    ...
    export const PJ_002AH = (props: ChipProps<typeof pinLabels>) => {
      return (
        <chip
          ...
          symbol={
            <symbol>
              <port name="pin3" pinNumber={3} aliases={["3"]} direction="right" schX={0.6} schY={0} schStemLength={0} />
              <schematicpath svgPath="M 0.6 0 L 0.2 0" strokeColor="#880000" />
              <port name="pin2" pinNumber={2} aliases={["2"]} direction="right" schX={0.6} schY={-0.2} schStemLength={0} />
              <schematicpath svgPath="M 0.6 -0.2 L 0.2 -0.2" strokeColor="#880000" />
              <port name="pin1" pinNumber={1} aliases={["1"]} direction="right" schX={0.6} schY={0.2} schStemLength={0} />
              <schematicpath svgPath="M 0.6 0.2 L 0.2 0.2" strokeColor="#880000" />

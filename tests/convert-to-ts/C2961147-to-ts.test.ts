...
it("should convert C2961147 into typescript file", async () => {
  ...
  expect(result).toMatchInlineSnapshot(`
    ...
    export const PJ_002AH = (props: ChipProps<typeof pinLabels>) => {
      ...
      "jlcpcb": [
        "C2961147"
          ...
          footprint={<footprint>
            <platedhole  portHints={["pin3"]} pcbX="-0mm" pcbY="2.2750082mm" holeWidth="0.999998mm" holeHeight="3.1999936mm" outerWidth="1.7999964mm" outerHeight="3.999992mm" shape="pill" />
    ...
    <platedhole  portHints={["pin1"]} pcbX="-2.999994mm" pcbY="-2.4250078mm" holeWidth="0.999998mm" holeHeight="3.499993mm" outerWidth="1.999996mm" outerHeight="4.499991mm" shape="pill" />

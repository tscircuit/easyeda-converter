    ...
    export const PJ_002AH = (props: ChipProps<typeof pinLabels>) => {
      return (
        <chip
          ...
          symbol={
            <symbol>
              <schematictext schX={-0.48} schY={0.53} text="{NAME}" fontSize={0.18} anchor="left" color="#006464" />
              ...
              <schematicrect schX={0.04} schY={0.2} width={0.08} height={0.24} color="#880000" strokeWidth={0.02} />

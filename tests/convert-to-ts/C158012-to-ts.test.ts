...
it("should convert C158012 into typescript file", async () => {
  ...
  expect(result).toMatchInlineSnapshot(`
    ...
    <courtyardoutline points={[{"x":-4.060012700000129,"y":3.80600000000004},{"x":4.059987299999875,"y":3.80600000000004},{"x":4.059987299999875,"y":-2.7899999999999636},{"x":-4.060012700000129,"y":-2.7899999999999636},{"x":-4.060012700000129,"y":3.80600000000004}]} />
          </footprint>}
          cadModel={{
            ...
            positionOffset: { x: -0.000012700000070253736, y: 0.47500540000010005, z: -0.049998300000038354 },
          }}
          {...props}
        />
      )

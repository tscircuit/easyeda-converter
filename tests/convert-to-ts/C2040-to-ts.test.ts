...
it("should convert C2040 into typescript file", async () => {
  ...
  expect(result).toMatchInlineSnapshot(`
    ...
    <courtyardoutline outline={[{"x":-1016.378016,"y":761.1912},{"x":-1007.9024159999999,"y":761.1912},{"x":-1007.9024159999999,"y":769.3874000000001},{"x":-1016.378016,"y":769.3874000000001},{"x":-1016.378016,"y":761.1912}]} />
          </footprint>}
          cadModel={{

...
it("should convert C165948 into typescript file", async () => {
  ...
  expect(result).toMatchInlineSnapshot(`
    ...
    <courtyardoutline outline={[{"x":-1021.3498119999998,"y":757.9654},{"x":-1010.9946119999998,"y":757.9654},{"x":-1010.9946119999998,"y":766.6949999999999},{"x":-1021.3498119999998,"y":766.6949999999999},{"x":-1021.3498119999998,"y":757.9654}]} />
          </footprint>}
          cadModel={{
            objUrl: "https://modelcdn.tscircuit.com/easyeda_models/download?uuid=617b05f9bba7410b96c001093d8189e4&pn=C165948",
            pcbRotationOffset: 180,
            modelOriginPosition: { x: 0, y: 0, z: 0.000010999999999872223 },
          }}
          {...props}
        />
      )

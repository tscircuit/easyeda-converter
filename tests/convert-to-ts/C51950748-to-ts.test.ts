...
it("should convert C51950748 into typescript file", async () => {
  ...
  expect(result).toMatchInlineSnapshot(`
    ...
    <silkscreencircle pcbX="-10.14984mm" pcbY="7.2999473mm" radius="0.199898mm" />
    <silkscreentext text="{NAME}" pcbX="-0.363728mm" pcbY="10.5648653mm" anchorAlignment="center" fontSize="1mm" />
    <courtyardoutline outline={[{"x":-9.87704450000001,"y":9.824961799999869},{"x":9.877044499999784,"y":9.824961799999869},{"x":9.877044499999784,"y":-12.365914299999986},{"x":-9.87704450000001,"y":-12.365914299999986},{"x":-9.87704450000001,"y":9.824961799999869}]} />
          </footprint>}
          cadModel={{

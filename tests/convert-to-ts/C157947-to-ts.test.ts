...
it("should convert C157947 into typescript file", async () => {
  ...
  expect(result).toMatchInlineSnapshot(`
    ...
    <platedhole  portHints={["pin1"]} pcbX="-8.999982mm" pcbY="0mm" holeWidth="0.999998mm" holeHeight="0.999998mm" outerWidth="1.499997mm" outerHeight="1.499997mm" rectPad={true} pcbRotation="0deg" shape="pill" />
    ...
    <courtyardoutline outline={[{"x":-11.26504019999993,"y":1.734985599999959},{"x":11.234915799999953,"y":1.734985599999959},{"x":11.234915799999953,"y":-6.364999199999943},{"x":-11.26504019999993,"y":-6.364999199999943},{"x":-11.26504019999993,"y":1.734985599999959}]} />
          </footprint>}
          cadModel={{

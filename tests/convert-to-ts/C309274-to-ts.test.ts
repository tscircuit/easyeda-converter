...
it("should convert C309274 into typescript file", async () => {
  ...
  expect(result).toMatchInlineSnapshot(`
        ...
        <chip
          ...
          symbol={
            <symbol>
              ...
              <port name="pin2" pinNumber={2} aliases={["2"]} direction="right" schX={0.6} schY={0.6} schStemLength={0} />
              <schematicpath svgPath="M 0.6 0.6 L 0.4 0.6" strokeColor="#880000" />
              <port name="pin3" pinNumber={3} aliases={["3"]} direction="right" schX={0.6} schY={0.4} schStemLength={0} />
              <schematicpath svgPath="M 0.6 0.4 L 0.4 0.4" strokeColor="#880000" />
              <port name="pin4" pinNumber={4} aliases={["4"]} direction="right" schX={0.6} schY={0.2} schStemLength={0} />
              <schematicpath svgPath="M 0.6 0.2 L 0.4 0.2" strokeColor="#880000" />
              <port name="pin5" pinNumber={5} aliases={["5"]} direction="right" schX={0.6} schY={0} schStemLength={0} />
              <schematicpath svgPath="M 0.6 0 L 0.4 0" strokeColor="#880000" />
              <port name="pin6" pinNumber={6} aliases={["6"]} direction="right" schX={0.6} schY={-0.2} schStemLength={0} />
              <schematicpath svgPath="M 0.6 -0.2 L 0.4 -0.2" strokeColor="#880000" />
              <port name="pin7" pinNumber={7} aliases={["7"]} direction="right" schX={0.6} schY={-0.4} schStemLength={0} />
              <schematicpath svgPath="M 0.6 -0.4 L 0.4 -0.4" strokeColor="#880000" />
    ...
    <fabricationnotepath route={[{"x":10.449991799999907,"y":4.45000379999999},{"x":13.5499855999999,"y":4.45000379999999},{"x":13.5499855999999,"y":-4.45000379999999},{"x":10.449991799999907,"y":-4.45000379999999},{"x":10.449991799999907,"y":4.45000379999999}]} strokeWidth="0.254mm" />

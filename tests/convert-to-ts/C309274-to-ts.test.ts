    ...
    export const PJ_609 = (props: ChipProps<typeof pinLabels>) => {
      ...
      "jlcpcb": [
        "C309274"
          ...
          footprint={<footprint>
            <platedhole  portHints={["pin2"]} pcbX="-6.299962mm" pcbY="-8.10006mm" holeWidth="0.7999984mm" holeHeight="2.3999952mm" outerWidth="1.5999968mm" outerHeight="3.1999936mm" shape="pill" />
    <platedhole  portHints={["pin3"]} pcbX="-6.299962mm" pcbY="8.10006mm" holeWidth="0.7999984mm" holeHeight="2.3999952mm" outerWidth="1.5999968mm" outerHeight="3.1999936mm" shape="pill" />
    <platedhole  portHints={["pin4"]} pcbX="0mm" pcbY="-8.10006mm" holeWidth="0.7999984mm" holeHeight="2.3999952mm" outerWidth="1.5999968mm" outerHeight="3.1999936mm" shape="pill" />
    <platedhole  portHints={["pin6"]} pcbX="6.299962mm" pcbY="-8.10006mm" holeWidth="0.7999984mm" holeHeight="2.3999952mm" outerWidth="1.5999968mm" outerHeight="3.1999936mm" shape="pill" />
    <platedhole  portHints={["pin7"]} pcbX="6.299962mm" pcbY="8.10006mm" holeWidth="0.7999984mm" holeHeight="2.3999952mm" outerWidth="1.5999968mm" outerHeight="3.1999936mm" shape="pill" />
    <platedhole  portHints={["pin5"]} pcbX="0mm" pcbY="8.10006mm" holeWidth="0.7999984mm" holeHeight="2.3999952mm" outerWidth="1.5999968mm" outerHeight="3.1999936mm" shape="pill" />

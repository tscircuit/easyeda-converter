...
it("should convert C6186 into typescript file", async () => {
  ...
  expect(result).toMatchInlineSnapshot(`
    ...
    <courtyardoutline outline={[{"x":-1020.5686222999999,"y":758.4226},{"x":-1011.1278223,"y":758.4226},{"x":-1011.1278223,"y":765.5773999999999},{"x":-1020.5686222999999,"y":765.5773999999999},{"x":-1020.5686222999999,"y":758.4226}]} />
          </footprint>}
          cadModel={{

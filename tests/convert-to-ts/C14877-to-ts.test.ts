...
it("should convert C14877 into typescript file", async () => {
  ...
  expect(result).toMatchInlineSnapshot(`
    ...
    const pinLabels = {
      pin1: ["_PCINT19","OC2B","INT1_PD3"],
      pin2: ["_PCINT20","XCK","T0_PD4"],
      pin3: ["GND3"],
      pin4: ["VCC2"],
      pin5: ["GND2"],
      pin6: ["VCC1"],
      pin7: ["_PCINT6","XTAL1","TOSC1_PB6"],
      pin8: ["_PCINT7","XTAL2","TOSC2_PB7"],
      pin9: ["_PCINT21","OC0B","T1_PD5"],
      pin10: ["_PCINT22","OC0A","AIN0_PD6"],
      pin11: ["_PCINT23","AIN1_PD7"],
      pin12: ["_PCINT0","CLKO","ICP1_PB0"],
      pin13: ["_PCINT1","OC1A_PB1"],
      pin14: ["_PCINT2","N_SS","OC1B_PB2"],
      pin15: ["_PCINT3","OC2A","MOSI_PB3"],
      pin16: ["_PCINT4","MISO_PB4"],
      pin17: ["PB5_SCK","PCINT5_"],
      pin18: ["AVCC"],
      pin19: ["ADC6"],
      pin20: ["AREF"],
      pin21: ["GND1"],
      pin22: ["ADC7"],
      pin23: ["PC0_ADC0","PCINT8_"],
      pin24: ["PC1_ADC1","PCINT9_"],
      pin25: ["PC2_ADC2","PCINT10_"],
      pin26: ["PC3_ADC3","PCINT11_"],
      pin27: ["PC4_ADC4","SDA","PCINT12_"],
      pin28: ["PC5_ADC5","SCL","PCINT13_"],
      pin29: ["N_PC6_RESET","PCINT14_"],
      pin30: ["PD0_RXD","PCINT16_"],
      pin31: ["PD1_TXD","PCINT17_"],
      pin32: ["PD2_INT0","PCINT18_"]
    } as const

...
it("should convert C14877 into typescript file", async () => {
  ...
  expect(result).toMatchInlineSnapshot(`
    ...
    const pinLabels = {
      pin1: ["(PCINT19/OC2B/INT1)PD3"],
      pin2: ["(PCINT20/XCK/T0)PD4"],
      pin3: ["GND3"],
      pin4: ["VCC2"],
      pin5: ["GND2"],
      pin6: ["VCC1"],
      pin7: ["(PCINT6/XTAL1/TOSC1)PB6"],
      pin8: ["(PCINT7/XTAL2/TOSC2)PB7"],
      pin9: ["(PCINT21/OC0B/T1)PD5"],
      pin10: ["(PCINT22/OC0A/AIN0)PD6"],
      pin11: ["(PCINT23/AIN1)PD7"],
      pin12: ["(PCINT0/CLKO/ICP1)PB0"],
      pin13: ["(PCINT1/OC1A)PB1"],
      pin14: ["(PCINT2/SS#/OC1B)PB2"],
      pin15: ["(PCINT3/OC2A/MOSI)PB3"],
      pin16: ["(PCINT4/MISO)PB4"],

    ...
    export const PV36W502C01B00 = (props: ChipProps<typeof pinLabels>) => {
      return (
        <chip
          ...
          symbol={
            <symbol>
              <port name="pin2" pinNumber={2} aliases={["2"]} direction="up" schX={0} schY={0.22} schStemLength={0} />
              <schematicpath svgPath="M 0 0.22 L 0 0.02" strokeColor="#880000" />
              ...
              <port name="pin1" pinNumber={1} aliases={["1"]} direction="right" schX={0.4} schY={-0.18} schStemLength={0} />
              <schematicpath svgPath="M 0.4 -0.18 L 0.2 -0.18" strokeColor="#8D2323" />
              <port name="pin3" pinNumber={3} aliases={["3"]} direction="left" schX={-0.4} schY={-0.18} schStemLength={0} />
              <schematicpath svgPath="M -0.4 -0.18 L -0.2 -0.18" strokeColor="#8D2323" />

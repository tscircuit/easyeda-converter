    ...
    export const SDFL2012S100KTF = (props: ChipProps<typeof pinLabels>) => {
      return (
        <chip
          ...
          symbol={
            <symbol>
              <port name="pin2" pinNumber={2} aliases={["2"]} direction="right" schX={0.4} schY={0} schStemLength={0} />
              <schematicpath svgPath="M 0.4 0 L 0.34 0" strokeColor="#800" />
              <port name="pin1" pinNumber={1} aliases={["1"]} direction="left" schX={-0.4} schY={0} schStemLength={0} />
              <schematicpath svgPath="M -0.4 0 L -0.34 0" strokeColor="#800" />

...
it("should convert C561765 into typescript file", async () => {
  ...
  expect(result).toMatchInlineSnapshot(`
    ...
    <platedhole  portHints={["pin1"]} pcbX="3.749929mm" pcbY="3.5400361mm" holeWidth="1.1999976mm" holeHeight="1.1999976mm" outerWidth="1.7999964mm" outerHeight="1.7999964mm" rectPad={true} pcbRotation="0deg" shape="pill" />
    ...
    <fabricationnotepath route={[{"x":-2.5999947999998767,"y":-6.859943100000123},{"x":-2.5999947999998767,"y":-8.309927500000072},{"x":2.5999947999999904,"y":-8.309927500000072},{"x":2.5999947999999904,"y":-6.859943100000123},{"x":-2.5999947999998767,"y":-6.859943100000123}]} strokeWidth="0.254mm" />
    <courtyardoutline outline={[{"x":-5.724995399999898,"y":4.690034299999979},{"x":5.724995400000012,"y":4.690034299999979},{"x":5.724995400000012,"y":-8.504936500000099},{"x":-5.724995399999898,"y":-8.504936500000099},{"x":-5.724995399999898,"y":4.690034299999979}]} />
          </footprint>}
          cadModel={{

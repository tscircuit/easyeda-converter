        ...
        <chip
          ...
          symbol={
            <symbol>
              ...
              <port name="pin1" pinNumber={1} aliases={["N_SD"]} direction="left" schX={-0.8} schY={0.5} schStemLength={0} />
              <schematicpath svgPath="M -0.8 0.5 L -0.4 0.5" strokeColor="#880000" />
              <port name="pin2" pinNumber={2} aliases={["IN_NEG"]} direction="left" schX={-0.8} schY={0.1} schStemLength={0} />
              <schematicpath svgPath="M -0.8 0.1 L -0.4 0.1" strokeColor="#880000" />
              <port name="pin3" pinNumber={3} aliases={["IN_POS"]} direction="left" schX={-0.8} schY={-0.3} schStemLength={0} />
              <schematicpath svgPath="M -0.8 -0.3 L -0.4 -0.3" strokeColor="#880000" />
              <port name="pin7" pinNumber={7} aliases={["GND"]} direction="down" schX={0} schY={-0.9} schStemLength={0} />
              <schematicpath svgPath="M 0 -0.9 L 0 -0.5" strokeColor="#000000" />
              <port name="pin5" pinNumber={5} aliases={["VO_POS"]} direction="right" schX={0.8} schY={-0.1} schStemLength={0} />
              <schematicpath svgPath="M 0.8 -0.1 L 0.4 -0.1" strokeColor="#880000" />
              <port name="pin6" pinNumber={6} aliases={["VDD"]} direction="up" schX={0} schY={0.7} schStemLength={0} />
              <schematicpath svgPath="M 0 0.7 L 0 0.3" strokeColor="#880000" />
              <port name="pin8" pinNumber={8} aliases={["VO_NEG"]} direction="right" schX={0.8} schY={-0.5} schStemLength={0} />
              <schematicpath svgPath="M 0.8 -0.5 L 0.4 -0.5" strokeColor="#880000" />
              <port name="pin4" pinNumber={4} aliases={["NC"]} direction="left" schX={-0.8} schY={-0.7} schStemLength={0} />
              <schematicpath svgPath="M -0.8 -0.7 L -0.4 -0.7" strokeColor="#880000" />

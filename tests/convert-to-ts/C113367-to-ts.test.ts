        ...
        <chip
          ...
          symbol={
            <symbol>
              ...
              <port name="pin3" pinNumber={3} aliases={["IN_POS"]} direction="left" schX={-0.8} schY={-0.3} schStemLength={0.4} schPinLabelFontSize={0.069231} />
              ...
              <port name="pin8" pinNumber={8} aliases={["VO_NEG"]} direction="right" schX={0.8} schY={-0.5} schStemLength={0.4} schPinLabelFontSize={0.075} />

...
it("should convert C105419 into typescript file", async () => {
  ...
  expect(result).toMatchInlineSnapshot(`
    ...
    <silkscreentext text={props.name} pcbX="-0.00788035mm" pcbY="8.585964mm" anchorAlignment="center" fontSize="1mm" />
    <courtyardoutline outline={[{"x":-8.15728034999995,"y":7.83596399999999},{"x":8.141519649999964,"y":7.83596399999999},{"x":8.141519649999964,"y":-7.802435999999943},{"x":-8.15728034999995,"y":-7.802435999999943},{"x":-8.15728034999995,"y":7.83596399999999}]} />
          ...
          cadModel={{
            ...
            pcbRotationOffset: 0,
            modelOriginPosition: { x: 0.04502800000001589, y: -0.19999960000004102, z: -0.05 },
          }}
          {...props}
        />
      )

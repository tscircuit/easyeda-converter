...
it("should convert C265111 into typescript file", async () => {
  ...
  expect(result).toMatchInlineSnapshot(`
    ...
    export const SM08B_GHS_TB_LF__SN_ = (props: ChipProps<typeof pinLabels>) => {
      return (
        <chip
          ...
          symbol={
            <symbol>
              <schematicrect schX={0.635} schY={2.54} width={6.35} height={22.86} strokeWidth={0.254} color="#880000" />
              <schematiccircle center={{ x: -1.27, y: 12.7 }} radius={0.381} strokeWidth={0.254} color="#880000" isFilled fillColor="#880000" />
              <port name="pin1" pinNumber={1} aliases={["1"]} direction="left" schX={-5.08} schY={11.43} schStemLength={2.54} />
              <port name="pin2" pinNumber={2} aliases={["2"]} direction="left" schX={-5.08} schY={8.89} schStemLength={2.54} />
              <port name="pin3" pinNumber={3} aliases={["3"]} direction="left" schX={-5.08} schY={6.35} schStemLength={2.54} />
              <port name="pin4" pinNumber={4} aliases={["4"]} direction="left" schX={-5.08} schY={3.81} schStemLength={2.54} />
              <port name="pin5" pinNumber={5} aliases={["5"]} direction="left" schX={-5.08} schY={1.27} schStemLength={2.54} />
              <port name="pin6" pinNumber={6} aliases={["6"]} direction="left" schX={-5.08} schY={-1.27} schStemLength={2.54} />
              <port name="pin7" pinNumber={7} aliases={["7"]} direction="left" schX={-5.08} schY={-3.81} schStemLength={2.54} />
              <port name="pin8" pinNumber={8} aliases={["8"]} direction="left" schX={-5.08} schY={-6.35} schStemLength={2.54} />
              <port name="pin9" pinNumber={9} aliases={["9"]} direction="down" schX={2.54} schY={-11.43} schStemLength={2.54} />
              <port name="pin10" pinNumber={10} aliases={["10"]} direction="up" schX={2.54} schY={16.51} schStemLength={2.54} />
            </symbol>
          }
          supplierPartNumbers={{
      "jlcpcb": [
    ...
    <silkscreenpath route={[{"x":-5.300218000000086,"y":2.3000335000000405},{"x":-5.307029359176454,"y":2.248296090522217},{"x":-5.326999253834288,"y":2.2000845000001163},{"x":-5.358766768654505,"y":2.158684268654497},{"x":-5.40016700000001,"y":2.1269167538343936},{"x":-5.448378590522111,"y":2.10694685917656},{"x":-5.5001159999999345,"y":2.1001355000001922},{"x":-5.551853409477985,"y":2.10694685917656},{"x":-5.600065000000086,"y":2.1269167538343936},{"x":-5.641465231345592,"y":2.158684268654497},{"x":-5.673232746165809,"y":2.2000845000001163},{"x":-5.693202640823529,"y":2.248296090522217},{"x":-5.70001400000001,"y":2.3000335000000405},{"x":-5.693202640823529,"y":2.351770909478091},{"x":-5.673232746165809,"y":2.399982500000192},{"x":-5.641465231345592,"y":2.4413827313456977},{"x":-5.600065000000086,"y":2.4731502461659147},{"x":-5.551853409477985,"y":2.493120140823521},{"x":-5.5001159999999345,"y":2.499931500000116},{"x":-5.448378590522111,"y":2.493120140823521},{"x":-5.40016700000001,"y":2.4731502461659147},{"x":-5.358766768654505,"y":2.4413827313456977},{"x":-5.326999253834288,"y":2.399982500000192},{"x":-5.307029359176454,"y":2.351770909478091},{"x":-5.300218000000086,"y":2.3000335000000405}]} />

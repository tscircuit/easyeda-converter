...
it("should convert C265111 into typescript file", async () => {
  ...
  expect(result).toMatchInlineSnapshot(`
    ...
    <silkscreencircle pcbX="-5.500116mm" pcbY="2.3000335mm" radius="0.199898mm" />
    <silkscreentext text="{NAME}" pcbX="0.014478mm" pcbY="3.6947495mm" anchorAlignment="center" fontSize="1mm" />
    <courtyardoutline outline={[{"x":-7.08003460000009,"y":2.949943800000028},{"x":7.08003460000009,"y":2.949943800000028},{"x":7.08003460000009,"y":-2.949943800000028},{"x":-7.08003460000009,"y":-2.949943800000028},{"x":-7.08003460000009,"y":2.949943800000028}]} />
          </footprint>}
          cadModel={{

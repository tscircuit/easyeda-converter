        ...
        <chip
          ...
          symbol={
            <symbol>
              ...
              <port name="pin3" pinNumber={3} aliases={["D"]} direction="up" schX={0.2} schY={0.4} schStemLength={0} />
              <schematicpath svgPath="M 0.2 0.4 L 0.2 0.2" strokeColor="#880000" />
              <schematictext schX={0.26} schY={0.14} text="D" fontSize={0.14} anchor="bottom_right" color="#006464" schRotation={270} />
              <schematictext schX={0.18} schY={0.22} text="3" fontSize={0.14} anchor="bottom_left" color="#A90000" schRotation={270} />
              <port name="pin1" pinNumber={1} aliases={["G"]} direction="left" schX={-0.4} schY={0} schStemLength={0} />
              <schematicpath svgPath="M -0.4 0 L -0.2 0" strokeColor="#880000" />
              <schematictext schX={-0.14} schY={-0.06} text="G" fontSize={0.14} anchor="bottom_left" color="#006464" schRotation={0} />
              <schematictext schX={-0.22} schY={0.02} text="1" fontSize={0.14} anchor="bottom_right" color="#A90000" schRotation={0} />
              <port name="pin2" pinNumber={2} aliases={["S"]} direction="down" schX={0.2} schY={-0.4} schStemLength={0} />
              <schematicpath svgPath="M 0.2 -0.4 L 0.2 -0.2" strokeColor="#880000" />
              <schematictext schX={0.26} schY={-0.14} text="S" fontSize={0.14} anchor="bottom_left" color="#006464" schRotation={270} />
              <schematictext schX={0.18} schY={-0.22} text="2" fontSize={0.14} anchor="bottom_right" color="#A90000" schRotation={270} />
            </symbol>
          }
          supplierPartNumbers={{
      "jlcpcb": [

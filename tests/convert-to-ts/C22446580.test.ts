...
it("should convert C22446580 into typescript file", async () => {
  ...
  expect(result).toMatchInlineSnapshot(`
    ...
    <silkscreenpath route={[{"x":-2.075179999999996,"y":1.5239492000000041},{"x":-2.2258220297039273,"y":1.672690255997665},{"x":-2.375199424014731,"y":1.522679200000006},{"x":-2.2258220297039273,"y":1.372668144002347},{"x":-2.075179999999996,"y":1.521409200000008}]} />
    <silkscreentext text="{NAME}" pcbX="-0.3175mm" pcbY="2.7526mm" anchorAlignment="center" fontSize="1mm" />
    <courtyardoutline outline={[{"x":-2.149996199999997,"y":2.149996200000004},{"x":2.149996200000004,"y":2.149996200000004},{"x":2.149996200000004,"y":-2.149996199999997},{"x":-2.149996199999997,"y":-2.149996199999997},{"x":-2.149996199999997,"y":2.149996200000004}]} />
          </footprint>}
          cadModel={{
